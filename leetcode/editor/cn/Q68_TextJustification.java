...
public class Q68_TextJustification {
    public static void main(String[] args) {
        Solution solution = new Q68_TextJustification().new Solution();
        List<String> fullJustify = solution.fullJustify(new String[]{"This", "is", "an", "example", "of", "text", "justification."}, 16);
        fullJustify.forEach(System.out::println);
    }
